# Code Style Guide - LexHOA

## Context

LexHOA code style rules for consistent development.
...
- **React Components**: Use PascalCase (e.g., `UserProfile`, `PaymentForm`)
- **Files**: PascalCase for components (e.g., `UserProfile.js`), camelCase for utilities (e.g., `apiClient.js`)
- **Directories**: kebab-case (e.g., `user-management/`, `board-tools/`)
- **Constants**: Use UPPER_SNAKE_CASE (e.g., `MAX_RETRY_COUNT`)
- **CSS Classes**: Use kebab-case (e.g., `.user-profile-card`)
